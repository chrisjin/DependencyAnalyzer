...
namespace CodeAnalyzer
{
        ...
        public override bool Test(SemiExpression semi)
        {
            ...
            if (indexdele>=0)
            {
                ...
                if (indexpar == indexdele + 3)
                {
                    ...
                    s.Property[PROPERTYKEY.USINGNAMESPACE] = String.Join(",", FileHeaderInfo.UsingNamespace);
                    //s.Property[PROPERTYKEY.FILENAME] = FileHeaderInfo.FileName;
                    this.Arg = s;
                    return true;
                }
            }
    ...
    public class IsMemberDeclaration: BaseRule
    {
        public override bool Test(SemiExpression semi)
        {
            ...
            if (tr.CurrentScope.IsGeneralClass())
            {
    ...
    {
        static private List<string> _VariableName=new List<string>();
        static public List<string> VariableName { get { return _VariableName; } }
        ...
        public override bool Test(SemiExpression semi)
        {
            ...
            if (indexnew != -1)
            {
                ...
                List<Scope> ls = new List<Scope>();
                if (indexnew + 1 < semi.Count)
                {
                    Scope s = Scope.MakeMember("public", semi[indexnew + 1], semi[indexnew + 1],
                           semi.LineCount, semi.LineCount, false);
    ...
    public class IsNamespace : BaseRule
    {
        public override bool Test(SemiExpression semi)
        {
            ...
            if (index != -1)
            {
                ...
                FileHeaderInfo.UsingNamespace.Add(semi[index + 1]);
                return true;
            }
            return false;
        }

...
namespace CodeAnalyzer
{
    ...
    public class Parser
    {
        ...
        public virtual void OnFileEnter(string name)
        {
        
        }
        public virtual void OnFileLeave(string name)
        { 
        }
        ...
        void ParseOneFile(string filename)
        {
            ...
            _ruletester.Test(ex);
            OnFileLeave(filename);
            Scope cscope = TypeRepository.Instance.CurrentScope;
            if (cscope != TypeRepository.Instance.RootScope)
            {
                System.Console.WriteLine("  Warning: {0}",filename);
            }
